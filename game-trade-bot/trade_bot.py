...
熱鍵（系統級，焦點在遊戲上也有效）：
  F1 = 立刻開始搬運
  F2 = 停止所有（停搬運＋停連點右鍵；都沒在跑時再按一次離開程式）
...
用法：
  python trade_bot.py            開啟熱鍵待命（F1 開始搬運 / F2 停止所有）
